    ...
    <div class="container-fluid">
        <form method='POST' action='settings.php'>
            <table class="table table-striped table-bordered" id="status" >
                ...
                <tbody>
                <tr valign='middle'><td align="right">Sort Column</td><td><select name ="sortoption"><option value="0" <?php if(isset($settings['sort']) && $settings['sort']==1) { echo 'selected="selected"'; } ?>>Name</option><option value="1">IP</option><option value="2" <?php if(isset($settings['sort']) && $settings['sort']==2) { echo 'selected="selected"'; } ?>>Auth</option><option value="3" <?php if(isset($settings['sort']) && $settings['sort']==3) { echo 'selected="selected"'; } ?>>Version</option><option value="4" <?php if(isset($settings['sort']) && $settings['sort']==4) { echo 'selected="selected"'; } ?>>Last Backup</option></select></td></tr>
